...
import static com.acmvit.code2create.UtilsInterface.compareDates;
import static com.acmvit.code2create.UtilsInterface.getDateObject;
...
public class FoodCouponsFragment extends Fragment {
    ...
    private void processScannable(List<Scannable> scannableList) {
        ...
        mAttendanceReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Map<String, String> couponUidList1 = new HashMap<>();
                Map<String, String> couponUidList2 = new HashMap<>();
                Map<String, String> couponUidList3 = new HashMap<>();

                if (couponsUser1 != null) {
                   couponUidList1 = couponsUser1.getCouponUidList();
                }

                CouponsUser couponsUser2 = dataSnapshot.child(scannable2.getScannableValue()).getValue(CouponsUser.class);
                if (couponsUser2 != null) {
                    couponUidList2 = couponsUser2.getCouponUidList();
                }

                CouponsUser couponsUser3 = dataSnapshot.child(scannable3.getScannableValue()).getValue(CouponsUser.class);
                if (couponsUser3 != null) {
                    couponUidList3 = couponsUser3.getCouponUidList();
                }
                if (context != null) {
                    setData(scannableList,
                            couponUidList1 == null ? null : couponUidList1.keySet(),
                            couponUidList2 == null ? null : couponUidList2.keySet(),
                            couponUidList3 == null ? null : couponUidList3.keySet());
                }
            }
    ...
    private void setData(List<Scannable> scannableList, Set<String> userList1, Set<String> userList2, Set<String> userList3) {
    ...
    private void checkPermission() {
        if (ContextCompat.checkSelfPermission(context,
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale
                ...
                if (sharedPreferences.getBoolean("FirstDeny", true)) {
                    Snackbar snackbar = Snackbar.make(getView().findViewById(R.id.container_food),
                            "Need audio permission to scan",
                            Snackbar.LENGTH_INDEFINITE).setAction("Grant",
                            new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    requestPermissions(
                                            new String[]{Manifest.permission
                                                    .RECORD_AUDIO},
                                            RESULT_REQUEST_RECORD_AUDIO);
                                    sharedPreferences.edit().putBoolean("FirstDeny", false).apply();
                                }
                            });
                    snackbar.show();
                } else {
                    Snackbar snackbar = Snackbar.make(getView().findViewById(R.id.container_food),
                            ...
                            new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    intent.setData(uri);
                                    startActivityForResult(intent, RESULT_REQUEST_RECORD_AUDIO);
                                }
                            });
                    snackbar.show();
                }
    ...
    private void checkAttendance(String eventId) {
        mAttendanceReference.child(eventId).child("couponUidList").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
